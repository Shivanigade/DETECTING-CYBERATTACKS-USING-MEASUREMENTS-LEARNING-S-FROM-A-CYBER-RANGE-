...
--
-- Host: localhost
-- Generation Time: Jan 19, 2023 at 12:57 PM
...
--
-- Database: `detecting_cyber_attacks`
--
CREATE DATABASE IF NOT EXISTS `detecting_cyber_attacks` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `detecting_cyber_attacks`;
...
(3, 'Gopal', 'Gopal123@gmail.com', 'Gopal', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(4, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'bangalore', '#8928,4th Cross,Rajajinagar', 'Male');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_detecting_cyber_attacks`
--

CREATE TABLE IF NOT EXISTS `remote_user_detecting_cyber_attacks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `spt` varchar(300) NOT NULL,
  `dpt` varchar(300) NOT NULL,
  `srcstr` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_detecting_cyber_attacks`
--

INSERT INTO `remote_user_detecting_cyber_attacks` (`id`, `rid`, `datetime`, `host`, `src`, `proto`, `type`, `spt`, `dpt`, `srcstr`, `cc`, `country`, `locale`, `latitude`, `longitude`, `Prediction`) VALUES
(5, '220.181.7.190-10.42.0.211-443-33887-6', '03-03-13 22:14', 'groucho-tokyo', '3639889826', 'TCP', 'Consumer Goods', '6000', '1433', '216.244.79.162', 'US', 'India', 'Washington', '47.4891', '-122.2908', 'No Cyber Attack Found'),
(6, '10.42.0.151-10.42.0.1-40169-53-17', '03-03-13 22:20', 'groucho-oregon', '1965603898', 'TCP', 'Military', '9907', '1433', '117.40.188.58', 'CN', 'China', 'Jiangxi Sheng', '28.55', '115.9333', 'Cyber Attack Found'),
(7, '03-03-13 22:53', 'groucho-oregon', '1032051418', '1032051418', 'TCP', 'Hotel', '6000', '1433', '61.131.218.218', 'C', 'China', 'Jiangxi Sheng', '28.55', '115.9333', 'No Cyber Attack Found'),
(8, '8.0.6.4-8.6.0.1-0-0-0', '03-03-13 22:55', 'groucho-us-east', '1729413584', 'TCP', 'Fashion', '4853', '445', '103.20.193.208', 'HK', 'Hong Kong', 'Not Defined', '22.25', '114.1667', 'Cyber Attack Found'),
(9, '172.217.10.42-10.42.0.211-443-48125-6', '03-04-13 8:01', 'groucho-tokyo', '1033071447', 'TCP', 'Military', '6000', '1433', '61.147.107.87', 'CN', 'China', 'Jiangsu Sheng', '32.0617', '118.7778', 'No Cyber Attack Found'),
(10, '172.217.10.106-10.42.0.211-443-59705-6', '03-04-13 0:56', 'groucho-tokyo', '1019193981', 'TCP', 'Financial,Credit Reporting', '6000', '135', '60.191.170.125', 'CN', 'China', 'Jiangsu Sheng', '32.4907', '119.9081', 'Cyber Attack Found');
...
(32, 'Extra Tree Classifier', '51.60060975609756'),
(33, 'SVM', '50.22865853658537'),
(34, 'Logistic Regression', '51.75304878048781'),
(35, 'Gradient Boosting Classifier', '52.0579268292683');
...
(26, 'No Cyber Attack Found', '50.0'),
(27, 'Cyber Attack Found', '50.0');
