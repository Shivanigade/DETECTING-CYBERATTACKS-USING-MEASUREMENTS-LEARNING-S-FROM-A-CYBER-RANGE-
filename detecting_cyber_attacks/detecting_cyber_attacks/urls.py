"""detecting_cyber_attacks URL Configuration
...
from detecting_cyber_attacks import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Cyber_Attack_Status/$', remoteuser.Predict_Cyber_Attack_Status, name="Predict_Cyber_Attack_Status"),
    ...
    url(r'^View_Cyber_Attack_Status_Ratio/$', serviceprovider.View_Cyber_Attack_Status_Ratio, name="View_Cyber_Attack_Status_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Cyber_Attack_Status/$', serviceprovider.View_Prediction_Cyber_Attack_Status, name="View_Prediction_Cyber_Attack_Status"),
